package com.example.gdroom_b_10779
...
import com.example.gdroom_b_10779.room.Constant
import com.example.gdroom_b_10779.room.Note
import com.example.gdroom_b_10779.room.NoteDB
...
class MainActivity : AppCompatActivity() {
    ...
    private fun deleteDialog(note: Note){
        ...
        alertDialog.apply {
            ...
            { dialogInterface, i -> dialogInterface.dismiss()
                CoroutineScope(Dispatchers.IO).launch { db.noteDao().deleteNote(note)
                    loadData()
                }
            })
        }
